...
(function (root, factory) {
	...
	function _init() {
		window.addEventListener("load", function() {
			Array.prototype.forEach.call(document.querySelectorAll("[st-data-tooltip]"), function(elm) {
				var tooltipText = elm.getAttribute("title");
				var options;

				if (tooltipText) {
					elm.setAttribute("title", "");
					options = _parseOptions(elm.getAttribute("st-data-tooltip"));
