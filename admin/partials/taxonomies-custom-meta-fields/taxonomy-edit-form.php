...
?>
<tr class="form-field">
 <th scope="row" valign="top"><label for="st-tax-lang"><?php esc_html( __( 'Language', 'straker-translations' ) ); ?></label></th>
   <td>
		<?php
		$term_meta = get_term_meta( $term->term_id, Straker_Translations_Config::straker_cat_lang_meta );
		$cat_meta  = ! empty( $term_meta ) ? get_term_meta( $term->term_id, Straker_Translations_Config::straker_cat_lang_meta, true ) : '';
		?>
