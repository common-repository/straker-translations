...
<div class="st-hr">
	<p>
		<?php echo esc_html( __( 'Use this page to manage original and source language of translated pages. Find the source pages of translated content.', 'straker-translations' ) ); ?>
	</p>
	<?php
